...
public class TrainerSteps {
	...
	public void the_user_clicks_on_the_trainer() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}
	...
	public void the_user_clicks_edit_trainer() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}
	...
	public void the_user_clicks_inactive_on_a_trainer() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}
	...
	public void the_trainer_is_made_inactive() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}
	...
	@Then("^The trainer name field should match trainer name for row \"([^\"]*)\"$")
	public void the_trainer_name_field_should_match_trainer_name_for_row(String arg1) throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}

	@Then("^The trainer email field should match trainer email for row \"([^\"]*)\"$")
	public void the_trainer_email_field_should_match_trainer_email_for_row(String arg1) throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}

	@Then("^The trainer title field should match trainer title for row \"([^\"]*)\"$")
	public void the_trainer_title_field_should_match_trainer_title_for_row(String arg1) throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}

	@Then("^The trainer role field should match trainer role for row \"([^\"]*)\"$")
	public void the_trainer_role_field_should_match_trainer_role_for_row(String arg1) throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}
