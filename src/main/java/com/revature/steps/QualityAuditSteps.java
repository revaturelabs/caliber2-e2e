...
public class QualityAuditSteps {
	...
	public void the_User_clicks_the_first_option_in_the_batch_dropdown_menu() throws Throwable {
	...
	public void the_batch_should_be(String arg1) throws Throwable {
	    ...
	    Assert.assertEquals(arg1, 
	    		qap.batchesDropdownOpenButton.findElement(By.tagName("a")).getText());
	}
	...
	public void user_selects_star_under_technical_skills_of_first_trainee() throws Throwable {
		...
		Thread.sleep(1000);
	    qap.getAssociateTechSkillsButton(qap.getTraineeRowByIndex(1)).findElement(By.tagName("em")).click();
	    Thread.sleep(1000);
	...
	public void first_trainee_has_star_in_technical_skills() throws Throwable {
		...
		Assert.assertTrue(qap.getAssociateTechSkillsButton(qap.getTraineeRowByIndex(1)).findElement(By.tagName("em")).getAttribute("class").contains("star"));
	}
	...
	public void user_selects_star_under_soft_skills_of_first_trainee() throws Throwable {
		Thread.sleep(1000);
		qap.getAssociateSoftSkillsButton(qap.getTraineeRowByIndex(1)).findElement(By.tagName("em")).click();
	    Thread.sleep(1000);
	...
	public void first_trainee_has_star_in_soft_skills() throws Throwable {
		Assert.assertTrue(qap.getAssociateSoftSkillsButton(qap.getTraineeRowByIndex(1)).findElement(By.tagName("em")).getAttribute("class").contains("star"));
	}
	...
	public void comment_is_deleted_from_trainee() throws Throwable {
		...
		Assert.assertTrue(qap.getTraineeRowByIndex(1).findElements(By.id("associate-details-container-flag")).size() == 0);
	...
	public void no_changes_are_made() throws Throwable {
	    	...
	    	Thread.sleep(1000);
	    	Assert.assertTrue(driver.findElements(By.id("associate-flag-dialog-cancel-button")).size() == 0);
	...
	public void user_selects_smily_face_under_overall_QC_Status() throws Throwable {
		Thread.sleep(1000);
		qap.getOverallQCFeedbackContainer().findElement(By.id("qc-feedback-dropdown-toggle")).click();
		Thread.sleep(1000);
		
		for(WebElement elem : qap.getOverallQCFeedbackContainer().findElement(By.id("qc-feedback-dropdown-toggle")).findElement(By.id("qc-feedback-dropdown-container")).findElements(By.tagName("em"))) {
	...
	public void smily_face_is_displayed_under_overall_QC_Status() throws Throwable {
		...
		Assert.assertTrue(qap.getOverallQCFeedbackContainer().findElement(By.id("qc-feedback-dropdown-toggle")).findElement(By.tagName("em")).getAttribute("class").contains("smile"));
	}

	@When("^User clicks \\+ button next to latest week$")
	public void user_clicks_button_next_to_latest_week() throws Throwable {
		
		cachedWeeks = qap.getWeekContainer().findElement(By.tagName("ul")).findElements(By.tagName("li")).size();
		qap.getWeekContainer().findElement(By.tagName("ul")).findElements(By.tagName("li")).get(cachedWeeks - 1).click();
	...
	public void no_changes_are_made_to_page() throws Throwable {
		Assert.assertEquals(cachedWeeks, qap.getWeekContainer().findElement(By.tagName("ul")).findElements(By.tagName("li")).size());
	}
	...
	public void new_week_is_added_to_page() throws Throwable {
		Assert.assertTrue(qap.getWeekContainer().findElement(By.tagName("ul")).findElements(By.tagName("li")).size() == (cachedWeeks + 1));
	}
	...
	public void user_types_in_notes_section(String arg1) throws Throwable {
	    qap.getTraineeRowByIndex(1).findElement(By.tagName("textarea")).sendKeys(arg1);
	}
	
	@Then("^First trainee notes should be \"([^\"]*)\"$")
	public void first_trainee_notes_should_be(String arg1) throws Throwable {
		Thread.sleep(1000);
	    String result = qap.getTraineeRowByIndex(1).findElement(By.tagName("textarea")).getAttribute("value");
	...
	public void user_clicks_pencil_icon_beside_trainee() throws Throwable {
		...
		action.moveToElement(qap.getAssociateDetailsContainer(qap.getTraineeRowByIndex(1)).findElement(By.id("associate-details-trainee-name")));
		Thread.sleep(333);
		action.perform();
	...
	public void comment_added_with_green_red_flag_icon_beside_Trainee(String arg1) throws Throwable {
		Actions actions = new Actions(driver);
		actions.moveToElement(qap.getAssociateDetailsFlag(qap.getTraineeRowByIndex(1)));
		actions.perform();
		Thread.sleep(333);
	   String result =  qap.getTraineeRowByIndex(1).findElement(By.tagName("bs-tooltip-container")).getText();
	...
	public void batch_should_be_displayed(String arg1) throws Throwable {
		Assert.assertEquals(arg1, qap.batchesDropdownOpenButton.findElement(By.tagName("a")).getText());
	}
	
	@Then("^No batches found should be displayed$")
	public void no_batches_found_should_be_displayed() throws Throwable {
	   Assert.assertTrue(qap.selectBatchesDropdownButton.getText().contains("No Batches Found"));
	}
	
	@When("^User types \"([^\"]*)\" in Overall QC Feedback section$")
	public void user_types_in_Overall_QC_Feedback_section(String arg1) throws Throwable {
		Thread.sleep(500);
	    qap.getOverallQCFeedbackContainer().findElement(By.tagName("textarea")).clear();
	    Thread.sleep(500);
	    qap.getOverallQCFeedbackContainer().findElement(By.tagName("textarea")).sendKeys(arg1);
	}
	
	@Then("^feedback should display \"([^\"]*)\"$")
	public void feedback_should_display(String arg1) throws Throwable {
	    Assert.assertEquals(arg1, qap.getOverallQCFeedbackContainer().findElement(By.tagName("textarea")).getAttribute("value"));
	}
