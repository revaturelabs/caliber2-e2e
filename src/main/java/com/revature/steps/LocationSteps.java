...
public class LocationSteps {
	...
	public void the_user_clicks_on_the_State_dropdown_menu() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}
	...
	@Then("^The location at row (\\d+) is updated with \"([^\"]*)\"$")
	public void the_location_at_row_is_updated_with(int arg1, String arg2) throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}

	@When("^The user clicks on make inactive for first active location$")
	public void the_user_clicks_on_make_inactive_for_first_active_location() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}

	@When("^The user clicks Reactivate$")
	public void the_user_clicks_Reactivate() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}

	@When("^The user clicks on make active for first inactive location$")
	public void the_user_clicks_on_make_active_for_first_inactive_location() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}

	@When("^The user clicks Delete$")
	public void the_user_clicks_Delete() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}

	@Then("^The location is made active$")
	public void the_location_is_made_active() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}
