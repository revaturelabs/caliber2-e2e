...
public class EditBatchModal {

	WebDriver driver;
	WebDriverWait wait = new WebDriverWait(driver, 3);

	public EditBatchModal(WebDriver driver) {
		this.driver = driver;
	...
	public WebElement submitUpdatedBatchButton() {
		return wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("batch-modal-update-button")));
	}
}
